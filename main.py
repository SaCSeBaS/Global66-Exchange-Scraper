...
try:
    ...
    if rate:
        print(f"Extraction DateTime: {now.isoformat()}")
        ...
        print(f"status: success | rate: {rate}")

    else:
        print(f"status: error | message: Rate not found in the response.")

except requests.exceptions.RequestException as e:
    print(f"status: error | message: Network error - {e}")

except Exception as e:
    print(f"status: error | message: An error occurred - {e}")